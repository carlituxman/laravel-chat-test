...
var NOTIF = {
    ...
    updateSubscription:function(subscription) {
        ...
        axios.post('/notification/subscriptions', data)
    ...
    deleteSubscription:function(subscription) {
        ...
        axios.post('/notification/subscriptions/delete', { endpoint: subscription.endpoint })
            .then(() => { this.loading = false })
    },
    ...
    sendNotification:function() {
        ...
        axios.post('/notification/notifications')
