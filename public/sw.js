...
const WebPush = {
    ...
    */
    dismissNotification ({ notification }, { endpoint }) {
        ...
        fetch(`/notification/notifications/${notification.data.id}/dismiss`, {
            method: 'POST',
            body: data
        })
    },
    ...
    /**
    * Send request to server to read a notification.
    *
    * @param  {NotificationEvent} event
    * @return {Response}
    */
    readNotification ({ notification }) {
        ...
        // Send a request to the server to mark the notification as read.
        fetch(`/notification/notifications/${notification.data.id}/read`, {
            method: 'PATCH',
        })
    }
}
